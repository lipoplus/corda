...
public class Scratchpad {
    ...
    public static void main(String[]args){
        ...
        HouseState outputState= new HouseState("123 Saldanha",null);
        ...
        builder.addOutputState(outputState, "java_bootcamp.HouseContract");
        builder.addCommand(new HouseContract.Register(), requiredSigners);
